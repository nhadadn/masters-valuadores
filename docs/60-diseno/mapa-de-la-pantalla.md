---
tipo: referencia
estado: VIGENTE — 13 de septiembre de 2026
...
| 4 | **Banda de borrador** | La franja amarilla que avisa de que los textos son propuesta | `AvisoBorrador.svelte` |
| 5 | **Migas de pan** | «Inicio › Empeño». Dice dónde estás y cómo volver | `Migas.svelte` |
| 6 | **Sección de entrada** | Todo el bloque oscuro de arriba, hasta donde empieza el claro | `[giro]/+page.svelte` |
...
| 16 | **Bloque de revisión** | El recuadro punteado «SOLO PARA LA REVISIÓN» | `[giro]/+page.svelte` |
...
| 21 | **Bloque de cifras** | «PORCENTAJE, PLAZO Y TASA» · pendiente a propósito | `[giro]/+page.svelte` |
| 22 | **Bloque de requisitos** | «QUÉ HAY QUE LLEVAR» · pendiente a propósito | `[giro]/+page.svelte` |
...
| 25 | **Acordeón** | Las preguntas que se abren y se cierran al tocarlas | `[giro]/+page.svelte` |
...
| accordion | **acordeón** | Sí · pieza 25 |
...
> «El **bloque de revisión** que salga después del **bloque de consulta**.»
