...
| 0058 | [[ADR-0058-taller-referencia-y-correo\|El taller según su volante, la referencia para llegar y el correo]] | **ACEPTADA** · aplica la tanda del 17 de septiembre, puntos 1–3 · el taller pasa de copy supuesto a mecánica diésel con diagnóstico donde estés y unidad de rescate · «Frente a Al Super del Periférico» junto a la dirección · correo en el pie, la ficha de contacto y el grafo · el guardia de fugas caza correos | 2026-09-17 |
| 0059 | [[ADR-0059-el-cierre-de-las-lineas-en-franja\|El cierre de las líneas, en franja]] | **ACEPTADA** · C1-B de la revisión de armonía · **enmienda el 0051** en las líneas: lienzo de 263 a 190 px, la ficha sin horarios y «¿Dónde están?» · la sección baja de 704 a 505 px a 390 · de paso, la numeración deja de empezar en «2» en financiamiento y taller | 2026-09-17 |
| 0060 | [[ADR-0060-los-claros-vuelven-a-pintar\|Los claros vuelven a pintar]] | **ACEPTADA** · C2 de la revisión · **enmienda el 0043**: `blanco` pinta el blanco y `marfil` la placa de acero; `tenue` y `crema` siguen siendo el suelo · el carrusel de empeño pasa a blanco · ninguna sección clara toca a otra del mismo grado · contraste mínimo sin cambio | 2026-09-17 |
| 0061 | [[ADR-0061-salen-los-rotulos-de-foto-de-archivo\|Salen los rótulos «FOTO DE ARCHIVO»]] | **ACEPTADA** · C7 de la revisión · **enmienda el 0009** y cierra lo que el 0031 dejó sin decidir · eran **cuatro**, no dos · queda `data-provisional` · en fletes y taller la foto de archivo ya no lleva ninguna marca visible · objeción registrada | 2026-09-17 |
