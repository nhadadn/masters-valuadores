...
| **El circuito del proceso se mueve**: excepción a la regla de movimiento —esconde texto hasta que llega—, con la objeción por escrito. En bucle, solo `transform`, `opacity` y `visibility` | `ADR-0050` | Nadir |
...
9 páginas · HTML de 3.3 a 7.9 KB gzip · **174 tests** · objetivo táctil mínimo 44 px ·
...
```
npm test                              # grafo, giros, fugas, tokens, SEO, flujo, mosaico, movimiento, ubicación y CA-10 · 174 tests
