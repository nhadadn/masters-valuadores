...
const PIEZAS = [
  ...
  /* ORDEN NUEVO · ADR-0027: la sección de bienes sube entre la tira de pasos y los
     botones, así que 14, 15 y 17 van ahora ANTES que 11, 12 y 13. Los números no se
     renumeran: ya son vocabulario y renumerar los invalidaría todos. */
