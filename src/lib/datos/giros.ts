...
export const giros: Giro[] = [
  ...
  // ADR-0058 · EL TALLER SEGÚN SU VOLANTE «Taller mecánico diesel» (tanda del 17 de septiembre):
  // servicios, diagnóstico donde te encuentres, unidad de rescate y qué atienden. Hasta aquí
  // decía «Servicio de taller» y «Traes tu unidad»: ninguna de sus piezas hablaba del taller.
  // Sigue siendo PROPUESTA, con sus palabras y sin sus superlativos.
  { slug: 'taller',              nombre: 'Taller',                    nombreCorto: 'Taller',      frasePropuesta: 'Mecánica diésel para camiones, pick ups, autobuses y maquinaria pesada', fotoProvisional: 'taller', fotoAlt: 'Manos de un mecánico eligiendo dados de una caja de herramienta', subtitularPropuesto: 'Mantenimiento general, reparación de motor, inyección, transmisión, frenos y suspensión. Hacemos el diagnóstico donde te encuentres y contamos con unidad de rescate.', pasosPropuestos: ['Nos dices qué le pasa a tu unidad: la traes o vamos a donde estés.', 'La diagnosticamos con escaneo computarizado y te decimos qué necesita.', 'Autorizas el trabajo y lo hacemos.'], flujo: [{ que: 'Nos dices qué falla', dato: 'la traes o vamos a donde estés', icono: 'taller' }, { que: 'La diagnosticamos', dato: 'con escaneo computarizado', icono: 'balanza' }, { que: 'Hacemos el trabajo', dato: 'cuando tú lo autorizas', icono: 'herramienta' }], tituloProceso: '¿Cómo es el servicio?', icono: 'taller',  estado: 'construible' },
