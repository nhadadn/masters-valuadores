<script lang="ts">
  /**
   * Página legal. El texto NO se inventa ni se copia de otro sitio: lo redacta el
   * cliente o su abogado. Un aviso de privacidad copiado es un problema legal
...
<svelte:head>
  <title>Términos · {negocio.nombreComercial} VALUADORES</title>
  <meta name="robots" content="noindex" />
</svelte:head>

<div class="migas"><Migas pasos={[{ texto: 'Inicio', href: '/' }, { texto: 'Términos' }]} /></div>
